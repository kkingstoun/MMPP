...
if __name__ == "__main__":
    ...
    #DATA
    #INIT
    parms = parameters.ovfParms(head="m_z", comp=0,tStart=200,tStop=800)
    #RUN
    m_stable = Marray(
                "E:/Mumax3-Projekty/Radek/circular_10.out/m_stable_30.ovf", parms)

    mtzyxc = Marray(
        "I:/Projekty/Dobrovolski/dyspersja_jednorodny3_ref.out/", parms)
    #SAVE
    mtzyxc.save("E:/arr.npz")
    #DATA
    ...
    #Init
    # dis = Dispersion()
    # dis.calculate_dispersion(mtzyxc.y(copy=True),
    #                          window="hanning", eachZ=True, zero_padd=False)
    # dis.save("E:/Mumax3-Projekty/Radek/circular_10.out2/arr_mody.npz")
